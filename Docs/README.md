...
| [NMT-Dashboard_Component_Specs.md](NMT-Dashboard_Component_Specs.md) | Comprehensive specifications for the membership dashboard components, including charts, metrics, filters, and layouts. *Note: This document may be consolidated with the Dashboard Design document in the Reports directory in the future.* |
...
| [Standards/NMT-Document_Structure_Standards.md](Standards/NMT-Document_Structure_Standards.md) | Standards for document structure, formatting, and organization across all project documentation. Defines the required sections and standard templates for different document types. |
| [Standards/NMT-Documentation_Style_Guide.md](Standards/NMT-Documentation_Style_Guide.md) | Comprehensive guide for writing style, terminology, formatting standards, and visual design principles to maintain consistency across all project documentation. |

### Deprecated Documents

| Document | Status | Reason | Replacement |
|----------|--------|--------|-------------|
| [NMT-Data_Structure.md](NMT-Data_Structure.md) | **DEPRECATED** | Consolidated | [NMT-Data_Model_Design_Consolidated.md](NMT-Data_Model_Design_Consolidated.md) |
| [NMT-Data_Model_Design.md](NMT-Data_Model_Design.md) | **DEPRECATED** | Consolidated | [NMT-Data_Model_Design_Consolidated.md](NMT-Data_Model_Design_Consolidated.md) |
...
- Provides comprehensive table of contents (where applicable)
...
- Follows the writing style defined in the [Documentation Style Guide](Standards/NMT-Documentation_Style_Guide.md)
- Adheres to structural conventions in the [Document Structure Standards](Standards/NMT-Document_Structure_Standards.md)
...
- Apex code and design is in the [Apex directory](../Apex/)
